...
ROOT_URLCONF = 'personalized_federated_learning.urls'
...
WSGI_APPLICATION = 'personalized_federated_learning.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'personalized_federated_learning',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
